...
public class Level_25_DataTest_V_Json extends BaseTest {
    ...
    public void beforeClass(String appURL, String browserName) {
        ...
        employeeUsername=employeeData.getEmloyeeUsername() + getRandomNumber();
        employeeEmail=employeeData.getEmloyeeEmailAddress() + getRandomNumber() +"@gmail.com";
    ...
    public void Employee_01_NewEmployee() {
        ...
        addEmployeePage.enterToTextboxByName(driver,"firstName",employeeData.getEmloyeeFirstName());
        addEmployeePage.enterToTextboxByName(driver,"lastName",employeeData.getEmloyeeLastName());
        ...
        addEmployeePage.enterToTextboxByLabel(driver,"Password",employeeData.getEmloyeePassword());
        addEmployeePage.enterToTextboxByLabel(driver,"Confirm Password",employeeData.getEmloyeePassword());
        ...
        verifyEquals(personalDetailPage.getTextboxValueByName(driver,"lastName"), employeeData.getEmloyeeLastName());
        verifyEquals(personalDetailPage.getTextboxValueByName(driver,"firstName"), employeeData.getEmloyeeFirstName() );
        ...
        loginPage.enterToTextboxByLabel(driver,"Password",employeeData.getEmloyeePassword());
