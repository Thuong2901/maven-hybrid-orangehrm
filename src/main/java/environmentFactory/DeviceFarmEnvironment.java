...
public class DeviceFarmEnvironment implements EnvironmentFactory{
    private WebDriver driver;
    private String platformName, browserName, browserVersion;

    public DeviceFarmEnvironment(WebDriver driver, String platformName, String browserName, String browserVersion) {
        this.driver = driver;
