...
public class SaucelabEnvironment implements EnvironmentFactory{
    private WebDriver driver;
    private String platformName, browserName, browserVersion;

    public SaucelabEnvironment(WebDriver driver, String platformName, String browserName, String browserVersion) {
        this.driver = driver;
